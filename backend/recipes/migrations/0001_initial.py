# Generated by Django 3.2 on 2024-08-21 04:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Укажите время приготовления 1 до 32000 минут.', validators=[django.core.validators.MinValueValidator(1, message='Время приготовления должно быть не менее 1 минуты.'), django.core.validators.MaxValueValidator(32000, message='Время приготовления должно быть не более 32000 минут.')], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(help_text='Количество ингредиентов должно быть от 1 до 32000', validators=[django.core.validators.MinValueValidator(1, message='Количество ингредиентов должно быть не меньше 1'), django.core.validators.MaxValueValidator(32000, message='Количество ингредиентов должно быть не больше 32000')], verbose_name='Количество')),
